...
use App\Http\Services\Product\SupplierAdminService;
...
//         }elseif ($data['dashboard_value'] == 'quy3'){$get = ThongKe::whereBetween('tk_Ngay',[$quy3_start, $quy3_end])->orderBy('tk_Ngay','asc')->get();
