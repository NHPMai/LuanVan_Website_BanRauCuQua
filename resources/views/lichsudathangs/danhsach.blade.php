  ...
  <table class="table pt-2">
    <thead style="background-color:blanchedalmond;">
      <tr>
        ...
        <th style="vertical-align: middle;text-align: center; font-size:16px; border: 1px solid LightGray;">Nhân viên giao hàng</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="vertical-align: middle; text-align:center;   font-size:16px;  border: 1px solid LightGray;">{{ $b->giaohangs->gh_hoten}}</td>

        @if( $b->dh_trangthai == 1)
        <td class="column-6" style="text-align: center;vertical-align: middle;  border: 1px solid LightGray; padding-left:0px; padding-right:0px">
        ...
        <td class="column-6" style="text-align: center;vertical-align: middle;  border: 1px solid LightGray; padding-left:0px; padding-right:0px">
          <span style="background-color: #68db2a; border-radius: 8px; font-weight:700; height: 40px;">Giao hàng thành công 
          </span>
        </td>
