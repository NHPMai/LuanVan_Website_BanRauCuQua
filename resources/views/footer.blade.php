	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-lg-3 p-b-10">
				<div class="block1 wrap-pic-w" style="border-radius: 50%; width: 180px;">
					<img src="/template/images/icons/logocp.png" alt="IMG-BANNER">
				</div>
			</div>
				...
				<ul>
					<li class="p-b-10">
						<a href="#" class="cl7 hov-cl1 trans-04">
							Thứ 2 - Thứ 6: 08:00 am - 08:30 pm
						</a>
					</li>

					<li class="p-b-10">
						<a href="#" class="cl7 hov-cl1 trans-04">
							Thứ 7: 10:00 am - 16:30 pm
						</a>
					</li>

					<li class="p-b-10">
						<a href="#" class="cl7 hov-cl1 trans-04">
							Chủ Nhật: 10:am - 16h30 pm
						</a>
					</li>
			...
			<div class="col-sm-6 col-lg-3 p-b-50" style="text-align: center">
				...
				<p class="cl7 size-201">
					Hãy liên hệ trực tiếp cửa hàng tại <br>
					Số 9, Trung Hiếu, Vũng Liêm, Vĩnh Long<br>
					Hoặc số điện thoai: 036 716 6879
				</p>
			...
			<div class="col-sm-6 col-lg-3 p-b-50 p-l-30">
				...
				<form>
					...
					<div class="p-t-18">
						<button class="flex-c-m  cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-04" style="text-align: center">
							Subscribe
						</button>
					</div>
				</form>
...
<script src="/template/js/sidebar/price-range.js"></script>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.choose').on('change', function() {
			...
			$.ajax({
				url: "{{url('/user/select_delivery_home')}}",
				method: "POST",
				data: {
					action: action,
					ma_id: ma_id,
...
<!-- <script type="text/javascript">
	$(document).ready(function() {
		$('.calculate_delivery').click(function() {
			...
			if (tinh_thanhpho_id == '' && quan_huyen_id == '' && xa_phuong_thitran_id == '') {
				...
				$.ajax({
					...
					data: {
						...
						xa_phuong_thitran_id: xa_phuong_thitran_id,
						_token: _token
					},
					success: function(data) {
...
<script type="text/javascript">
	function binhluandonhang(id) {
		...
		$.ajax({
			...
			data: {
				id: id,
				binhluandonhang: binhluandonhang,
				_token: _token
			},
			success: function(data) {
