    ...
    <table class="table">
        <tbody>
            ...
            <tr>
                ...
                <td class="column-2" style="text-align: center;vertical-align: middle">{{ $chitietdonhang->product->ten }}</td>
                <td class="column-3" style="text-align: center;vertical-align: middle">{{ number_format($price, 0, '', '.') }}</td>
                <td class="column-4" style="text-align: center;vertical-align: middle">{{ $chitietdonhang->ctdh_soluong }}</td>
                <td class="column-5" style="text-align: center;vertical-align: middle">{{ number_format($price, 0, '', '.') }}</td>
                @if( $donhang->dh_trangthai == 1)
                <td class="column-6"style="text-align: center;vertical-align: middle">Chờ duyệt</td>
                @elseif( $donhang->dh_trangthai == 2)
                <td class="column-6"style="text-align: center;vertical-align: middle">Đã Duyệt</td>
                @elseif( $donhang->dh_trangthai == 3)
                <td class="column-6" style="text-align: center;vertical-align: middle">Đang giao</td>
                @elseif( $donhang->dh_trangthai == 4)
                <td class="column-6" style="text-align: center;vertical-align: middle">Giao hàng thành công</td>
                @endif
            </tr>
            @endforeach
            <tr>
