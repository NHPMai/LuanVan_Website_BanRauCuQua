...
<form action="" method="POST">
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="hoten" value="{{ old('hoten') }}" class="form-control" placeholder="Nhập tên nhà cung cấp">
                </div>
        ...
        <div class="form-group">
            ...
            <textarea type="text" name="diachi" value="{{ old('diachi') }}" class="form-control" placeholder="Nhập địa chỉ"></textarea>
        </div>
