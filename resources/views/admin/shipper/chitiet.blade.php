...
<div class="customer mt-3">
    <ul>
        ...
        <li>Tên khách hàng: <strong>{{ $giaohang->gh_hoten}}</strong></li>
        <li>Số điện thoại: <strong>{{ $giaohang->gh_sodienthoai }}</strong></li>
        <li>Địa chỉ: <strong>{{ $giaohang->gh_diachi }}</strong></li>
        <li>Email: <strong>{{ $giaohang->email }}</strong></li>
        <li>Giới tính: 
        ...
        <li>Ngày sinh: <strong>{{ $giaohang->gh_ngaysinh}}</strong></li>
        <li>Trạng thái: 
...
<p style="font-weight:bold; font-size: 20px; ">Tổng Số Đơn Hàng Giao: {{$donhangs->count()}}</p>
...
<table class="table pt-2">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="column-6" style="text-align: center;vertical-align: middle; border: 1px solid LightGray;">
                <span style="background-color: #68db2a; border-radius: 8px;  font-weight:600">Giao hàng thành công</i></span>
            </td>
