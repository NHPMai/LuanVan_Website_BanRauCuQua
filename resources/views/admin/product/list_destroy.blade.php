...
<table class="table pt-2" id="myTable">
    <thead style="background-color:blanchedalmond;">
        <tr>
            ...
            <th style="text-align: center;vertical-align: middle; border: 1px solid LightGray;">Giá (vnđ)</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="vertical-align: middle;text-align: center; font-weight:600; color:firebrick; border: 1px solid LightGray; padding-left:0px; padding-right:0px" >{{number_format($product->gia, 0,',','.') }}</td>
